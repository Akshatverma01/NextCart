...
export default function ContactFormWithSocialButtons() {
  const { hasCopied, onCopy } = useClipboard("akshat0104verma@gmail.com");
  const [formData, setFormData] = useState({
    name: "",
    email: "",
    message: "",
  });
  const { sendEmail } = useProductStore();
  ...
  return (
    ...
    >
       ...
       <Box
        ...
        p={{ base: 5, md: 16, lg: 16 }}
        w={{ base: "70%", sm: "80%", md: "80%", lg: "70%" }}
        maxW="700px"
        h={"100%"}
        ...
        <VStack spacing={{ base: 6, md: 10 }}>
          ...
          >
            <Stack
              ...
              justify="center"
            >
              <Tooltip label={hasCopied ? "Email Copied!" : "Copy Email"} hasArrow>
                <IconButton
                  aria-label="email"
                  variant="ghost"
                  size="lg"
              ...
              <Box as="a" href="https://github.com/Akshatverma01" target="_blank">
                <IconButton
                  aria-label="github"
                  variant="ghost"
                  size="lg"
              ...
              <Box as="a" href="https://www.linkedin.com/in/akshat-verma-2b6106228/" target="_blank">
                <IconButton
                  aria-label="linkedin"
                  variant="ghost"
                  size="lg"
              ...
              <VStack spacing={5} w="full">
                <form onSubmit={handleSubmit} style={{ width: "100%" }}>
                  ...
                  <Button
                    ...
                    _hover={{ bg: "blue.600" }}
                    isLoading={isClick}
                    loadingText={isClick ?"Sending...":"Sent"}
                  >
                    Send Message
                  </Button>
                </form>
